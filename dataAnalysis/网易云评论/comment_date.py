...
# 获取评论日期
df['time'] = pd.to_datetime([i.split(' ')[0] for i in df['date']])
...
attr = date_com['time']
v1 = date_com['count']
line = Line("歌曲发布后评论的日期分布", title_pos='center', title_top='18', width=800, height=400)
