...
geo = Geo("BOSS直聘数据分析岗—城市分布热力图", title_pos='center', title_top='0', width=800, height=400, title_color="#fff", background_color="#404a59",)
attr = city_com_last['job_city']
value = city_com_last['count']
geo.add("", attr, value, type="heatmap", is_visualmap=True, visual_range=[0, 30], visual_text_color="#fff")
geo.render("BOSS直聘数据分析岗—城市分布热力图.html")
