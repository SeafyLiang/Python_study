...
data = [[], [], [], [], [], [], [], [], []]
dom1, dom2, dom3, dom4, dom5, dom6, dom7, dom8, dom9 = data
...
boxplot = Boxplot("BOSS直聘数据分析岗—公司状态薪水图(元/月)", title_pos='center', title_top='18', width=800, height=400)
...
boxplot.render("BOSS直聘数据分析岗—公司状态薪水图.html")