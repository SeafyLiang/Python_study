...
df1 = pd.read_csv('Best_Actress_LR.csv', header=None, names=['year', 'win', 'nomination'], encoding='gbk')
df2 = pd.read_csv('Best_Actress_SR.csv', header=None, names=['year', 'win', 'nomination'], encoding='gbk')
...
bar = Bar("奥斯卡女演员-提名统计", title_pos='center', title_top='18', width=800, height=400)
